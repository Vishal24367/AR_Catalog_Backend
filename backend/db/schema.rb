...
ActiveRecord::Schema.define(version: 2020_08_11_081456) do
  ...
  create_table "students", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["ar_class_id"], name: "index_students_on_ar_class_id"
  ...
  create_table "vehicle_brands", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["vehicle_type"], name: "index_vehicle_brands_on_vehicle_type"
  end
  ...
  add_foreign_key "students", "ar_classes"
